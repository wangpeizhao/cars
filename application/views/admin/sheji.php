...
<!--
	...
	function getContent(term,index){
		try{
			$.post(baseUrl + lang + "/admin/sheji",{term:term,act:'get'}, function(data){
				if(data.done===true){
      ...
      <div class="content link_target" align="left">
		...
		<div class="div_box">
			<div class="div" style="margin-left:10px;" align="left">
				<form method="post" action="<?=WEB_DOMAIN.(_LANGUAGE_=='en'?'/en':'')?>/admin/sheji" target="ajaxifr" onSubmit="return checkForm();">
