    ...
    <div class="content_box">
      <div class="content link_target" align="left">
        ...
        <div class="content form_content" style="height: 298px;">
          <form method="post" name="ModelForm" action="<?=WEB_DOMAIN.(_LANGUAGE_=='en'?'/en':'')?>/admin/system/editNewsInfo" novalidate="true" enctype="multipart/form-data" target="ajaxifr" onSubmit="return checkForm();">
              ...
              <table class="form_table">
				...
				<?php }}}}?>
				  ...
				  <tr>
                    <th></th>
                    <td>
						<button type="submit" class="submit"><span>修改新闻资讯</span></button>
