...
<script type='text/javascript' src="<?=site_url('')?>/themes/admin/js/admin_premier_recycle_list.js"></script>
	...
	<div class="headbar">
		<form action="" method="POST" name="_Form_" target="_MrParker_">
			...
			<div class="operating">
				...
				<div class="operating"> 
					<a href="/admin/premier/index" id="import"><button class="operating_btn" type="button"><span class="import">返回列表</span></button></a> 
