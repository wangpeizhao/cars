              ...
              <table class="form_table">
                ...
                <tbody>
                  ...
                  <tr>
                    <th><?=$_title_?>登录名：</th>
                    <td>
                      <input type="text" title="<?=$_title_?>登录名不能为空" required placeholder="登录名" pattern="\S" value="<?=isset($data['username'])?$data['username']:''?>" name="username" class="normal">
                  ...
                  <tr>
                    <th><?=$_title_?>真实姓名：</th>
                    <td>
                      <input type="text" title="<?=$_title_?>真实姓名不能为空" required placeholder="真实姓名" pattern="\S" value="<?=isset($data['nickname'])?$data['nickname']:''?>" name="nickname" class="normal">
                      <label style="color:red;">*</label>
                    </td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                    <th><?=$_title_?>所属部门：</th>
                    <td>
                      <input type="text" title="<?=$_title_?>所属部门" placeholder="所属部门" value="<?=isset($data['branch'])?$data['branch']:''?>" name="branch" class="normal">
                      <label style="color:red;"></label>
                    </td>
                  </tr>
                  <tr>
                    <th><?=$_title_?>Email：</th>
                    <td>
                      <input type="text" title="<?=$_title_?>Email" placeholder="登录名" parsley-type="email" value="<?=isset($data['email'])?$data['email']:''?>" name="email" class="normal">
                      <label style="color:red;"></label>
                    </td>
                  </tr>
                  <tr>
                    <th><?=$_title_?>电话号码：</th>
                    <td>
                      <input type="text" title="<?=$_title_?>电话号码" placeholder="电话号码" parsley-type="phone" value="<?=isset($data['phone'])?$data['phone']:''?>" name="phone" class="normal">
                      <label style="color:red;"></label>
                    </td>
                  </tr>
                  <tr>
                    <th><?=$_title_?>手机号码：</th>
                    <td>
                      <input type="text" title="<?=$_title_?>手机号码" placeholder="手机号码" parsley-type="mobile" value="<?=isset($data['mobile'])?$data['mobile']:''?>" name="mobile" class="normal">
                      <label style="color:red;"></label>
                    </td>
                  </tr>
                  <tr>
                    <th><?=$_title_?>QQ号码：</th>
                    <td>
                      <input type="text" title="<?=$_title_?>QQ号码" placeholder="QQ号码" parsley-type="number" value="<?=isset($data['qq'])?$data['qq']:''?>" name="qq" class="normal">
                      <label style="color:red;"></label>
                    </td>
                  </tr>
                  <tr>
                    <th><?=$_title_?>微信号码：</th>
                    <td>
                      <input type="text" title="<?=$_title_?>微信号码" placeholder="微信号码" value="<?=isset($data['weixin'])?$data['weixin']:''?>" name="weixin" class="normal">
                      <label style="color:red;"></label>
                    </td>
                  </tr>
                  <tr>
                    <th><?=$_title_?>个人描述：</th>
                    <td>
                      <textarea title="<?=$_title_?>个人描述" placeholder="个人描述" value="" name="describe" class="normal"><?=isset($data['describe'])?$data['describe']:''?></textarea>
                      <label style="color:red;"></label>
                    </td>
                  </tr>
                  <tr>
                    <th><?=$_title_?>排序：</th>
                    <td>
                      <input type="number" title="<?=$_title_?>排序-越大越靠前" parsley-type="digits" placeholder="排序-越大越靠前" value="<?=isset($data['sort'])?$data['sort']:''?>" name="sort" class="normal">
                      <label style="color:red;"></label>
                    </td>
                  </tr>
				          <tr>
