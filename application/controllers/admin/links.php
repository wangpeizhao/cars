...
class Links extends Fzhao_Controller {

    protected $_type_ = 'links';
    protected $_title_ = '友情链接';
...
//        $this->checkLP(); //检测登录状态和权限
    ...
    function edit($id = null) {
        ...
        if (IS_POST) {
            ...
            $data['_title_'] = $this->_title_;
            $data['_type_'] = $this->_type_;
            $this->view('admin/linksEdit', $data);
        }
    }
    ...
    function recycle() {
        ...
        if (IS_POST) {
            ...
            $data['_title_'] = $this->_title_;
            $data['_type_'] = $this->_type_;
            $this->view('admin/linksRecycle', $data);
        }
    }
