...
*/
    this.messages = {
      ...
      , type: {
          ...
          , mobile:     "This value should be a valid mobile number."
		  , phoneemail: "This value should be a valid phone or a valid email."
        }
          ...
          validate: function ( val, type ) {
            ...
            switch ( type ) {
              ...
              case 'phone':
				...
				regExp = /(^(([0\+]\d{2,3}[-| ])?(0\d{2,3})[-| ])?(\d{6,8})([-| ](\d{3,}))?$)|(^((\+86)?(86)?(0))?1[3|4|5|6|7|8][0-9]{9}$)/;
                break;
              case 'telephone':
				//regExp = /^((\+\d{1,3}(-| )?\(?\d\)?(-| )?\d{1,5})|(\(?\d{2,6}\)?))(-| )?(\d{3,4})(-| )?(\d{4})(( x| ext)\d{1,5}){0,1}$/;
				regExp = /^(([0\+]\d{2,3}[-| ])?(0\d{2,3})[-| ])?(\d{6,8})([-| ](\d{3,}))?$/;
                break;
              case 'mobile':
				regExp = /^((\+86)?(86)?(0))?1[3|4|5|6|7|8][0-9]{9}$/;
                break;
              case 'phoneemail':
				//regExp = /^((\+\d{1,3}(-| )?\(?\d\)?(-| )?\d{1,5})|(\(?\d{2,6}\)?))(-| )?(\d{3,4})(-| )?(\d{4})(( x| ext)\d{1,5}){0,1}$/;
				regExp = /((^(([0\+]\d{2,3}[-| ])?(0\d{2,3})[-| ])?(\d{6,8})([-| ](\d{3,}))?$)|(^((\+86)?(86)?(0))?1[3|4|5|6|7|8][0-9]{9}$))|(^((([a-z]|\d|[!#\$%&'\*\+\-\/=\?\^_`{\|}~]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])+(\.([a-z]|\d|[!#\$%&'\*\+\-\/=\?\^_`{\|}~]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])+)*)|((\x22)((((\x20|\x09)*(\x0d\x0a))?(\x20|\x09)+)?(([\x01-\x08\x0b\x0c\x0e-\x1f\x7f]|\x21|[\x23-\x5b]|[\x5d-\x7e]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(\\([\x01-\x09\x0b\x0c\x0d-\x7f]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF]))))*(((\x20|\x09)*(\x0d\x0a))?(\x20|\x09)+)?(\x22)))@((([a-z]|\d|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(([a-z]|\d|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])([a-z]|\d|-|\.|_|~|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])*([a-z]|\d|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])))\.)+(([a-z]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(([a-z]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])([a-z]|\d|-|\.|_|~|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])*([a-z]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF]))){2,6}$)/;
                break;
              default:
                return false;
            }
