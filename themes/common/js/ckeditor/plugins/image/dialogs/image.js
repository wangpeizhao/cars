                ...
                elements: [{
                    ...
                    children: [{
                        ...
                        }*/
						{
							type:'button',
							id:'myUpload',
							style: "display:inline-block;margin-top:13px;cursor:pointer;",
							align:'center',
							label:'上传/浏览已上传',//c.lang.common.browseServer,
							onClick:function(){
								var isChrome = window.navigator.userAgent.indexOf("Chrome") !== -1;
								if(isChrome){
									var retFile = open(baseUrl+"/admin/upload/uploadImage", '', 'menubar=no,location=no,resizable=yes,scrollbars=yes,status=no,width=730px,height=500px');
									_getDialog = this.getDialog();
									//this.getDialog().setValueOf('info','txtUrl',_retFile);
								}else{
									var retFile = showModalDialog(baseUrl+"/admin/upload/uploadImage", "", "dialogHeight:500px;dialogWidth:730px;"); 
									if(retFile != null){
