                ...
                elements: [{
                    ...
                    children: [{
                        ...
                        },*/
						{
							...
							align:'center',
							label:'上传/浏览已上传',//a.lang.common.browseServer,
							onClick:function(){
								var isChrome = window.navigator.userAgent.indexOf("Chrome") !== -1;
								if(isChrome){
									var retFile = open(baseUrl+"/admin/upload/uploadVideo", '', 'menubar=no,location=no,resizable=yes,scrollbars=yes,status=no,width=730px,height=500px');
									_getDialog = this.getDialog();
									//this.getDialog().setValueOf('info','txtUrl',_retFile);
								}else{
									var retFile = showModalDialog(baseUrl+"/admin/upload/uploadVideo", "", "dialogHeight:500px;dialogWidth:730px;"); 
									if(retFile != null){
