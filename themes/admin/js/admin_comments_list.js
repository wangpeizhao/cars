function setData(currPage) {
    try {
        $.ajax({
            type: "POST",
            url: baseUrl+lang + '/admin/system/comment',
            data: {
                currPage: currPage,
                rows: rows,
                condition: condition
...
function fillData(data, currPage) {
    try {
        ...
        for (var i = 0; i < data.length; i++) {
            ...
            html += '	<td id="' + data[i]['id'] + '"><a href="javascript:;" act="edit"><img class="operator" src="' + site_url + '/themes/admin/images/icon_edit.gif" alt="回复" title="回复" /></a><a act="del" href="javascript:;"><img class="operator" src="' + site_url + '/themes/admin/images/icon_del.gif" alt="删除" title="删除" /></a></td>';
            html += '</tr>'
        }
