function setData(currPage) {
    try {
        $.ajax({
            type: "POST",
            url: baseUrl+lang + '/admin/system/adminRecycleList',
            data: {
                currPage: currPage,
                rows: rows
            },
...
function fillData(data, currPage) {
    try {
        ...
        for (var i = 0; i < data.length; i++) {
            ...
            html += '	<td uid="' + data[i]['id'] + '"><a href="javascript:;" act="recover"><img class="operator" src="' + site_url + '/themes/admin/images/icon_recover.gif" alt="还原" title="还原" /></a><a act="del" href="javascript:;"><img class="operator" src="' + site_url + '/themes/admin/images/icon_del.gif" alt="彻底删除" title="彻底删除" /></a></td>';
            html += '	<td></td>';
            html += '</tr>'
        }
